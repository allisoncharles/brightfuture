...
import styles from "../../../styles/CreateGallery.module.css";
  ...
  return (
    <>
      ...
      <div className={styles.create__gallery}>
        {token && !loading && (
          <>
            <div ref={adminNavRef} className={styles.create__gallery__left}>
              <AdminNav />
            </div>
            <div className={styles.create__gallery__right}>
