import styles from "../../../styles/FeaturedAD.module.css";
import AdminNav from "../../../components/AdminNav";
import FeaturedComponent from "../../../components/FeaturedComponent";
import { GET_ALL_FEATURED } from "../../../graphql/queries";
...
const FeaturedAD = ({ featuredRes }) => {
  ...
  return (
    <>
      <NavBar />
      <div className={styles.admin__featured}>
        {token && !loading && (
          <>
            <div ref={adminNavRef} className={styles.admin__featured__left}>
              <AdminNav />
            </div>
            <div className={styles.admin__featured__right}>
              ...
              <FeaturedComponent featuredRes={featuredRes} />
            </div>
          </>
        )}
      </div>
...
export async function getServerSideProps({ req, res }) {
  ...
  const featuredRes = await client.query({ query: GET_ALL_FEATURED });
  return {
    props: {
      featuredRes: featuredRes?.data?.getAllFeatured ?? [],
    },
  };
}
