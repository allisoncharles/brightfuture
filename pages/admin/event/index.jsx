import styles from "../../../styles/EventAD.module.css";
import AdminNav from "../../../components/AdminNav";
import EventComponent from "../../../components/EventComponent";
import { GET_ALL_EVENT } from "../../../graphql/queries";
...
const News = ({ eventRes }) => {
  ...
  return (
    <>
      <NavBar />
      <div className={styles.admin__event}>
        {token && !loading && (
          <>
            <div ref={adminNavRef} className={styles.admin__event__left}>
              <AdminNav />
            </div>
            <div className={styles.admin__event__right}>
              ...
              <EventComponent eventRes={eventRes} />
            </div>
          </>
        )}
      </div>
...
export async function getServerSideProps({ req, res }) {
  ...
  const eventRes = await client.query({ query: GET_ALL_EVENT });
  return {
    props: {
      eventRes: eventRes?.data?.getAllEvent ?? [],
    },
  };
}
